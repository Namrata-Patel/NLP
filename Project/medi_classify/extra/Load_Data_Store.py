...
def main():
    ...
    if pdf is not None:
        with st.spinner('Wait for it...'):
            ...
            import os
            os.environ["PINECONE_API_KEY"] = "c90b562b-0985-43e7-9949-dc502745b36e"
            
            push_to_pinecone(os.getenv("PINECONE_API_KEY"),"gcp-starter","mediclassify3",embeddings,docs_chunks)
